...
class PocketPDB:
    ...
    def find_close_lig_contact_chainB(self,d_cutoff=None):
        if d_cutoff == None:
            cutoff_use = CUTOFF
        else:
            cutoff_use = d_cutoff
            ...
            for line in fp:
                if line.startswith('ATOM'):
                    ...
                    if atm.chainID != 'A':
                        ...
                        if atm.resNo not in chainB_resno:
                            chainB_resno.append(atm.resNo)
                    else:
        ...
        #include peptide residues as packable
        for resno in chainB_resno:
            contact_resno.append(resno)
